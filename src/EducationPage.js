        ...
        <Cyf>
            ...
            <ul>
                ...
                <li><strong>Modules</strong>| HTML, CSS, JavaScript, React, Node.js, PostgreSQL<br/>
                    The syllabus can be found <a href='https://syllabus.codeyourfuture.io/'> here.</a></li><br/>
                <li><strong>Final Project</strong>| <a href='https://dev-graduate-directory.herokuapp.com/' >CYF Graduate Directory</a>. A platform to help CYF graduates get hired.</li><br/>       
            </ul>
            </div>
            <a href='https://codeyourfuture.io/'><CyfImg src={cyf} alt="cyf logo"/></a>
        </Cyf>
        <Gcu>
            ...
            <a href='https://www.gcu.ac.uk/study/courses/details/index.php/P03178/International_Business_Management/' ><GcuImg src={gcu} alt="gcu logo"/></a>
        </Gcu>
        <Ug>
            ...
            <a href='https://nust.edu.pk/'><UgImg src={nust} alt="nust logo"/></a>
