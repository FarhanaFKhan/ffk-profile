        ...
        <Content>
            <ul>
                <ListElement><strong>CYF Graduate Directory:</strong> As part of the CYF Full Stack Web development programme, I worked on to develop a platform for the CYF graduates in order to help them get hired.<br/>
                    ...
                    <a href="https://dev-graduate-directory.herokuapp.com/" target="_blank">Preview</a> <strong>|</strong> <a href="https://github.com/OBakir90/cyf-final-project-pgsql-starter-kit/tree/develop" target="_blank">GitHub Repo</a></ListElement> <br/>

                <ListElement><strong>TV Show DOM Project:</strong> Created a TV show guide using JavaScript DOM and calling APIs <br/>
                <a href="https://cyf-farhanafkhan-tv.netlify.app/" target="_blank">Preview</a> <strong>|</strong> <a href="https://github.com/FarhanaFKhan/tv-show-dom-project" target="_blank">GitHub Repo</a> <br/>
                </ListElement> <br/>    
            ...
            <p>More work can be viewed on <a href="https://github.com/FarhanaFKhan" target="_blank">GitHub</a></p>
        </Content>
        <Footer />
